...
/*   Updated: 2018/07/29 04:51:25 by amanuel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_arg_uox(t_id *id, char c)
{
	...
	if (id->hash && c == 8 && *buff != '0' && (id->ins = 1))
		buff = ft_strjoin_free("0", buff, 0, 1);
	else if ((id->ins || id->hash) && c == 16 && (id->ins = 2))
		buff = ft_strjoin_free("0x", buff, 0, 1);
...
void			ft_exe_flags(t_id *id, char **buff)
{
	...
	id->p = ft_strjoin_free(id->p, *buff, 1, 1);
}
